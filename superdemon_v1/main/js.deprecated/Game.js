...
export const Game = {
    ...
    draw() {
        ...
        try {
            ...
            const dotSize = 4;
            const ramColor = this.player.overheat > 0 ? '#f00' : '#0ff';
            ...
            for (let i = 0; i < this.player.maxRam; i++) {
                ...
                if (i < this.player.ram) {
                    ...
                    this.ctx.shadowBlur = 5; this.ctx.shadowColor = ramColor;
                    this.ctx.fill();
                    this.ctx.shadowBlur = 0;
                } else {
                    // Empty (Used)
            ...
            if (this.nukeCharge > 0) {
                this.ctx.beginPath();
                this.ctx.arc(px, py, 100 * this.nukeCharge, 0, Math.PI * 2);
            ...
            this.em.particles.forEach(p => {
                ...
                if (p.type === 'confetti') {
                    ...
                    this.ctx.fillStyle = '#0f0';
                    this.ctx.font = '12px UnifrakturMaguntia';
            ...
            this.em.texts.forEach(t => {
                ...
                this.ctx.font = `bold ${t.size}px UnifrakturMaguntia`;
