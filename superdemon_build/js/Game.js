...
export const Game = {
    ...
    startWithTransition() {
        ...
        // 1. Force audio resume (User Interaction)
        try {
            AudioSys.init();
        ...
        setTimeout(() => {
            try {
                ...
                // Fallback: Ensure UI is hidden if game fails to start partially?
                screen.style.display = 'none';
            }
        }, 1200);
    },
        ...
        try {
            ...
            this.em.spawnQueue.forEach(s => {
                ...
                if (s.type === 3) { // Singularity
                    this.ctx.strokeStyle = `rgba(255, 20, 20, ${1 - s.timer / 60})`; // Bright Red
                }
